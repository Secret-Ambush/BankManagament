...
public class Categories extends JFrame {
	...
	public Categories() {
		...
		catTitle.setForeground(new Color(255, 255, 255));
		...
		cat_id.setForeground(new Color(255, 255, 255));
		...
		JLabel cat_id_2 = new JLabel("NAME OF INCHARGE:");
		cat_id_2.setForeground(new Color(255, 255, 255));
		...
		addcat.setForeground(new Color(0, 128, 128));
		...
		upd_cat.setForeground(new Color(0, 128, 128));
		...
		del_cat.setForeground(new Color(0, 128, 128));
		...
		mainmenubtn.setBounds(699, 217, 105, 30);
